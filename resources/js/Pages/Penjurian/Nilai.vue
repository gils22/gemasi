    ...
    <div class="space-y-4">
        <Card>
            <CardHeader class="space-y-3">
                ...
                <div v-if="isPrivileged" class="space-y-2">
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            v-if="juriOptions.length === 0"
                            class="text-xs text-amber-600"
                        >
                            Belum ada penugasan juri untuk kategori ini.
                        </span>
                    </div>
                    <div v-if="juriOptions.length" class="flex flex-wrap gap-2">
                        <button
            ...
            <CardContent class="space-y-4">
                ...
                <div class="md:hidden space-y-3">
                    ...
                    >
                        ...
                        <div class="mt-3">
                            <label class="text-xs text-slate-500">Nilai (0-100)</label>
                            <Input
                                v-model.number="item.nilai"
                                type="number"
                                min="0"
                ...
                <div class="grid gap-3 md:grid-cols-2">
                    ...
                    <div class="rounded-lg border p-3">
                        ...
                        <p class="text-xl font-semibold text-slate-900">
                            {{
                                page.props.nilaiTersimpan !== null
                                    ? page.props.nilaiTersimpan.toFixed(2)
                                    : "-"
                            }}
                        </p>
                    </div>
                ...
                <div class="space-y-2">
                    <label class="text-sm font-medium"
                        >Catatan Juri (opsional)</label
                    >
                    <textarea
                        v-model="catatan"
                        rows="4"
                        class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                        placeholder="Catatan tambahan untuk karya ini"
                    />
                </div>

                <div class="flex justify-end">
                    <Button :disabled="submitting" class="w-full md:w-auto flex items-center gap-2" @click="simpan">
